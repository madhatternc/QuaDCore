...
--
-- Table structure for table `logoncharacters`
--

DROP TABLE IF EXISTS `logoncharacters`;
CREATE TABLE `logoncharacters` (
  `logonid` int(11) unsigned NOT NULL default '0',
  `acctid` bigint(20) unsigned NOT NULL,
  `numchars` tinyint(3) unsigned NOT NULL default '0',
  PRIMARY KEY  (`logonid`,`acctid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='Logon Character Tracker';

--
-- Dumping data for table `logoncharacters`
--

LOCK TABLES `logoncharacters` WRITE;
/*!40000 ALTER TABLE `logoncharacters` DISABLE KEYS */;
/*!40000 ALTER TABLE `logoncharacters` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `logonlist`
--
...
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='Logon System';

--
-- Dumping data for table `logonlist`
--

LOCK TABLES `logonlist` WRITE;
/*!40000 ALTER TABLE `logonlist` DISABLE KEYS */;
INSERT INTO `logonlist` VALUES
(1,'Quad','127.0.0.1',8085,1,0,1,0,0);
...
CREATE TABLE `uptime` (
  `logonid` int(11) unsigned NOT NULL,
  `starttime` bigint(20) unsigned NOT NULL default '0',
  `startstring` varchar(64) NOT NULL default '',
  `uptime` bigint(20) unsigned NOT NULL default '0',
  `maxplayers` smallint(5) unsigned NOT NULL default '0',
  PRIMARY KEY  (`logonid`,`starttime`)
