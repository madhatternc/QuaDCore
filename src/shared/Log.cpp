...
void Log::outDB( LogTypes type, const char * str )
{
    ...
    LoginDatabase.PExecute("INSERT INTO logs (time, logon, type, string) "
        "VALUES ("I64FMTD", %u, %u, '%s');", uint64(time(0)), logon, (uint32)type, new_str.c_str());
}
