...
enum WorldConfigs
{
    ...
    CONFIG_CHARACTERS_PER_LOGON,
    CONFIG_HEROIC_CHARACTERS_PER_LOGON,
...
enum LogonType
{
    LOGON_TYPE_NORMAL = 0,
    LOGON_TYPE_PVP = 1,
    LOGON_TYPE_NORMAL2 = 4,
    LOGON_TYPE_RP = 6,
    LOGON_TYPE_RPPVP = 8,
    LOGON_TYPE_FFA_PVP = 16                                 // custom, free for all pvp mode like arena PvP in all zones except rest activated places and sanctuaries
                                                            // replaced by LOGON_PVP in logon list
};

enum LogonZone
{
    LOGON_ZONE_UNKNOWN       = 0,                           // any language
    LOGON_ZONE_DEVELOPMENT   = 1,                           // any language
    LOGON_ZONE_UNITED_STATES = 2,                           // extended-Latin
    LOGON_ZONE_OCEANIC       = 3,                           // extended-Latin
    LOGON_ZONE_LATIN_AMERICA = 4,                           // extended-Latin
    LOGON_ZONE_TOURNAMENT_5  = 5,                           // basic-Latin at create, any at login
    LOGON_ZONE_KOREA         = 6,                           // East-Asian
    LOGON_ZONE_TOURNAMENT_7  = 7,                           // basic-Latin at create, any at login
    LOGON_ZONE_ENGLISH       = 8,                           // extended-Latin
    LOGON_ZONE_GERMAN        = 9,                           // extended-Latin
    LOGON_ZONE_FRENCH        = 10,                          // extended-Latin
    LOGON_ZONE_SPANISH       = 11,                          // extended-Latin
    LOGON_ZONE_RUSSIAN       = 12,                          // Cyrillic
    LOGON_ZONE_TOURNAMENT_13 = 13,                          // basic-Latin at create, any at login
    LOGON_ZONE_TAIWAN        = 14,                          // East-Asian
    LOGON_ZONE_TOURNAMENT_15 = 15,                          // basic-Latin at create, any at login
    LOGON_ZONE_CHINA         = 16,                          // East-Asian
    LOGON_ZONE_CN1           = 17,                          // basic-Latin at create, any at login
    LOGON_ZONE_CN2           = 18,                          // basic-Latin at create, any at login
    LOGON_ZONE_CN3           = 19,                          // basic-Latin at create, any at login
    LOGON_ZONE_CN4           = 20,                          // basic-Latin at create, any at login
    LOGON_ZONE_CN5           = 21,                          // basic-Latin at create, any at login
    LOGON_ZONE_CN6           = 22,                          // basic-Latin at create, any at login
    LOGON_ZONE_CN7           = 23,                          // basic-Latin at create, any at login
    LOGON_ZONE_CN8           = 24,                          // basic-Latin at create, any at login
    LOGON_ZONE_TOURNAMENT_25 = 25,                          // basic-Latin at create, any at login
    LOGON_ZONE_TEST_SERVER   = 26,                          // any language
    LOGON_ZONE_TOURNAMENT_27 = 27,                          // basic-Latin at create, any at login
    LOGON_ZONE_QA_SERVER     = 28,                          // any language
    LOGON_ZONE_CN9           = 29                           // basic-Latin at create, any at login
};
...
class World
{
    public:
        ...
        bool IsPvPLogon() { return (getConfig(CONFIG_GAME_TYPE) == LOGON_TYPE_PVP || getConfig(CONFIG_GAME_TYPE) == LOGON_TYPE_RPPVP || getConfig(CONFIG_GAME_TYPE) == LOGON_TYPE_FFA_PVP); }
        bool IsFFAPvPLogon() { return getConfig(CONFIG_GAME_TYPE) == LOGON_TYPE_FFA_PVP; }
        ...
        void UpdateLogonCharCount(uint32 accid);
    ...
    protected:
        ...
        void ScriptsProcess();
        // callback for UpdateLogonCharacters
        void _UpdateLogonCharCount(QueryResult *resultCharCount, uint32 accountId);
