...
#define QuadCore              Quad
#define GetQuadCoreString     GetQuadString
...
enum ResponseCodes
{
    ...
    LOGON_LIST_IN_PROGRESS                                 = 0x23,
    LOGON_LIST_SUCCESS                                     = 0x24,
    LOGON_LIST_FAILED                                      = 0x25,
    LOGON_LIST_INVALID                                     = 0x26,
    LOGON_LIST_LOGON_NOT_FOUND                             = 0x27,
