...
{
    Quad::MessageDeliverer post_man(*player, msg, to_possessor, to_self);
...
{
    Quad::ObjectMessageDeliverer post_man(*obj, msg, to_possessor);
...
{
    Quad::MessageDistDeliverer post_man(*player, msg, to_possessor, dist, to_self, own_team_only);
    VisitWorld(player->GetPositionX(), player->GetPositionY(), World::GetMaxVisibleDistance(), post_man);
}

void Map::MessageDistBroadcast(WorldObject *obj, WorldPacket *msg, float dist, bool to_possessor)
{
    Quad::ObjectMessageDistDeliverer post_man(*obj, msg, to_possessor, dist);
    VisitWorld(obj->GetPositionX(), obj->GetPositionY(), World::GetMaxVisibleDistance(), post_man);
}
...
void Map::Update(const uint32 &t_diff)
{
    ...
    for(m_mapRefIter = m_mapRefManager.begin(); m_mapRefIter != m_mapRefManager.end(); ++m_mapRefIter)
    {
        ...
        {
            Quad::PlayerVisibilityNotifier notifier(*plr);
