...
class HashMapHolder
{
    public:
        ...
        typedef Quad::GeneralLock<LockType > Guard;
...
class QUAD_DLL_DECL ObjectAccessor : public Quad::Singleton<ObjectAccessor, Quad::ClassLevelLockable<ObjectAccessor, ZThread::FastMutex> >
{
