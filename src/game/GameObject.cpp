        ...
        case GO_READY:
        {
            ...
            if(goInfo->type == GAMEOBJECT_TYPE_TRAP)
            {
                ...
                else                                        // environmental trap
                {
                    ...
                    // affect only players
                    Player* player = NULL;
                    QuadCore::AnyPlayerInObjectRangeCheck checker(this, radius);
                    QuadCore::PlayerSearcher<QuadCore::AnyPlayerInObjectRangeCheck> searcher(this, player, checker);
...
void GameObject::TriggeringLinkedGameObject( uint32 trapEntry, Unit* target)
{
    ...
    GameObject* trapGO = NULL;
    {
        ...
        QuadCore::NearestGameObjectEntryInObjectRangeCheck go_check(*target,trapEntry,range);
        QuadCore::GameObjectLastSearcher<QuadCore::NearestGameObjectEntryInObjectRangeCheck> checker(this, trapGO,go_check);
...
GameObject* GameObject::LookupFishingHoleAround(float range)
{
    ...
    Cell cell(p);
    cell.data.Part.reserved = ALL_DISTRICT;
    QuadCore::NearestGameObjectFishingHole u_check(*this, range);
    QuadCore::GameObjectSearcher<QuadCore::NearestGameObjectFishingHole> checker(this, ok, u_check);
