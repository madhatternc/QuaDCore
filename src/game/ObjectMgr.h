...
// quadcore string ranges
#define MIN_QUAD_STRING_ID    1
#define MAX_QUAD_STRING_ID    2000000000
#define MIN_DB_SCRIPT_STRING_ID MAX_QUAD_STRING_ID
...
typedef UNORDERED_MAP<uint32,QuadStringLocale> QuadStringLocaleMap;
...
QUAD_DLL_SPEC bool LoadQuadStrings(DatabaseType& db, char const* table,int32 start_value = -1, int32 end_value = std::numeric_limits<int32>::min());
