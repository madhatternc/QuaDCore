...
class QUAD_DLL_DECL WorldLog : public Quad::Singleton<WorldLog, Quad::ClassLevelLockable<WorldLog, ZThread::FastMutex> >
{
    friend class Quad::OperatorNew<WorldLog>;
    WorldLog();
    WorldLog(const WorldLog &);
    WorldLog& operator=(const WorldLog &);
    typedef Quad::ClassLevelLockable<WorldLog, ZThread::FastMutex>::Lock Guard;
