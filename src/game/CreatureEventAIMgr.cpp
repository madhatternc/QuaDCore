...
void CreatureEventAIMgr::LoadCreatureEventAI_Texts()
{
    ...
    // Load EventAI Text
    LoadQuadStrings(WorldDatabase,"creature_ai_texts",-1,1+(TEXT_SOURCE_RANGE));
...
void CreatureEventAIMgr::LoadCreatureEventAI_Summons()
{
    ...
    if (result)
    {
        ...
        do
        {
            ...
            if(!QuadCore::IsValidMapCoord(temp.position_x,temp.position_y,temp.position_z,temp.orientation))
            {
