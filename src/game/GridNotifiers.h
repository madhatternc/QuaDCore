...
namespace Quad
{
    ...
    struct QUAD_DLL_DECL Deliverer
    {
    ...
    struct QUAD_DLL_DECL MessageDeliverer : public Deliverer
    {
    ...
    struct QUAD_DLL_DECL ObjectMessageDeliverer : public Deliverer
    {
    ...
    struct QUAD_DLL_DECL MessageDistDeliverer : public Deliverer
    {
        bool i_ownTeamOnly;
    ...
    struct QUAD_DLL_DECL ObjectMessageDistDeliverer : public Deliverer
    {
