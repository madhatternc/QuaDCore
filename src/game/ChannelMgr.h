...
#ifndef QUADCORE_CHANNELMGR_H
#define QUADCORE_CHANNELMGR_H
...
inline ChannelMgr* channelMgr(uint32 team)
{
    if (sWorld.getConfig(CONFIG_ALLOW_TWO_SIDE_INTERACTION_CHANNEL))
        ...
        return &Quad::Singleton<AllianceChannelMgr>::Instance();

    if(team==ALLIANCE)
        return &Quad::Singleton<AllianceChannelMgr>::Instance();
    if(team==HORDE)
        return &Quad::Singleton<HordeChannelMgr>::Instance();
    return NULL;
}
#endif
