...
{
    // NOT USED BY ANY SPELL OR USELESS OR IMPLEMENTED IN DIFFERENT WAY IN QUADCORE
}
...
void Spell::EffectAddHonor(uint32 /*i*/)
{
    ...
    if( damage <= 50)
    {
        uint32 honor_reward = QuadCore::Honor::hk_honor_at_level(unitTarget->getLevel(), damage);
...
void Spell::EffectSanctuary(uint32 /*i*/)
{
    ...
    Quad::AnyUnfriendlyUnitInObjectRangeCheck u_check(unitTarget, unitTarget, World::GetMaxVisibleDistance());
