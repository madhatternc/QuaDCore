...
void WorldSession::HandleTextEmoteOpcode( WorldPacket & recv_data )
{
    ...
    QuadCore::EmoteChatBuilder emote_builder(*GetPlayer(), text_emote, emoteNum, unit);
    QuadCore::LocalizedPacketDo<QuadCore::EmoteChatBuilder > emote_do(emote_builder);
    QuadCore::PlayerDistWorker<QuadCore::LocalizedPacketDo<QuadCore::EmoteChatBuilder > > emote_worker(GetPlayer(),sWorld.getConfig(CONFIG_LISTEN_RANGE_TEXTEMOTE),emote_do);
    TypeContainerVisitor<QuadCore::PlayerDistWorker<QuadCore::LocalizedPacketDo<QuadCore::EmoteChatBuilder > >, WorldTypeMapContainer > message(emote_worker);
