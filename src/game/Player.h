...
// 2^n values, Player::m_isunderwater is a bitmask. These are quadcore internal values, they are never send to any client
...
enum TransferAbortReason
{
    ...
    TRANSFER_ABORT_TOO_MANY_LOGON_INSTANCES = 0x09          // Additional instances cannot be launched, please try again later.
};
...
enum PlayerLoginQueryIndex
{
    ...
    PLAYER_LOGIN_QUERY_LOADTUTORIALS            = 7,        // common for all characters for some account at specific logon
...
class QUAD_DLL_SPEC Player : public Unit
{
    ...
    public:
        ...
        static void DeleteFromDB(uint64 playerguid, uint32 accountId, bool updateLogonChars = true);
