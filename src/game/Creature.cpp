...
void Creature::DoFleeToGetAssistance(float radius) // Optional parameter
{
    ...
    Quad::NearestAssistCreatureInCreatureRangeCheck u_check(this,getVictim(),radius);
    Quad::CreatureLastSearcher<Quad::NearestAssistCreatureInCreatureRangeCheck> searcher(this, pCreature, u_check);
    ...
    if( !m_AlreadyCallAssistance && getVictim() && !isPet() && !isCharmed())
    {
        ...
        if(radius > 0)
        {
...

            {
                ...
                QuadCore::AnyAssistCreatureInRangeCheck u_check(this, getVictim(), radius);
                QuadCore::CreatureListSearcher<QuadCore::AnyAssistCreatureInRangeCheck> searcher(this, assistList, u_check);
