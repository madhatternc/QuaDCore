...
GameObject* ChatHandler::GetObjectGlobalyWithGuidOrNearWithDbGuid(uint32 lowguid,uint32 entry)
{
    ...
    if(!obj && objmgr.GetGOData(lowguid))                   // guid is DB guid of object
    {
        ...
        QuadCore::GameObjectWithDbGUIDCheck go_check(*pl,lowguid);
        QuadCore::GameObjectSearcher<QuadCore::GameObjectWithDbGUIDCheck> checker(pl,obj,go_check);
...
const char *CliHandler::GetQuadString(int32 entry) const
{
