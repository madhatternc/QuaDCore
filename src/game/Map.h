...
typedef Quad::SingleThreaded<GridRWLock>::Lock NullGuard;
...
class QUAD_DLL_SPEC Map : public GridRefManager<NGridType>, public Quad::ObjectLevelLockable<Map, ZThread::Mutex>
{
    ...
    protected:
        ...
        typedef Quad::ObjectLevelLockable<Map, ZThread::Mutex>::Lock Guard;
