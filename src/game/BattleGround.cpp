...
namespace QuadCore
{
    ...
    class BattleGround2ChatBuilder
    {
        public:
            ...
            {
                char const* text = objmgr.GetQuadCoreString(i_textId,loc_idx);
                char const* arg1str = i_arg1 ? objmgr.GetQuadCoreString(i_arg1,loc_idx) : "";
                char const* arg2str = i_arg2 ? objmgr.GetQuadCoreString(i_arg2,loc_idx) : "";
...
uint32 BattleGround::GetBonusHonorFromKill(uint32 kills) const
{
    ...
    return QuadCore::Honor::hk_honor_at_level(GetMaxLevel(), kills);
}
...
{
    QuadCore::BattleGroundChatBuilder bg_builder(type, entry, source);
    QuadCore::LocalizedPacketDo<QuadCore::BattleGroundChatBuilder> bg_do(bg_builder);
...
void BattleGround::PSendMessageToAll(int32 entry, ChatMsg type, Player const* source, ...)
{
    ...
    QuadCore::BattleGroundChatBuilder bg_builder(type, entry, source, &ap);
    QuadCore::LocalizedPacketDo<QuadCore::BattleGroundChatBuilder> bg_do(bg_builder);
    BroadcastWorker(bg_do);
...
{
    QuadCore::BattleGround2ChatBuilder bg_builder(type, entry, source, arg1, arg2);
    QuadCore::LocalizedPacketDo<QuadCore::BattleGround2ChatBuilder> bg_do(bg_builder);
    BroadcastWorker(bg_do);
}
