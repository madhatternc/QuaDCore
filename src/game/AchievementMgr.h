...
#ifndef __QUADCORE_ACHIEVEMENTMGR_H
#define __QUADCORE_ACHIEVEMENTMGR_H
...
class AchievementGlobalMgr
{
    public:
        ...
        bool IsLogonCompleted(AchievementEntry const* achievement) const
        {
            return m_allCompletedAchievements.find(achievement->ID) != m_allCompletedAchievements.end();
        }

        void SetLogonCompleted(AchievementEntry const* achievement)
        {
