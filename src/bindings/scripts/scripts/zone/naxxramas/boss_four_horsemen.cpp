 ...
 */
    ...
    struct QUAD_DLL_DECL boss_lady_blaumeuxAI : public ScriptedAI
    {
  ...
  //baron rivendare
   ...
   struct QUAD_DLL_DECL boss_rivendare_naxxAI : public ScriptedAI
   {
   ...
   struct QUAD_DLL_DECL boss_thane_korthazzAI : public ScriptedAI
   {
   ...
   struct QUAD_DLL_DECL boss_sir_zeliekAI : public ScriptedAI
   {
