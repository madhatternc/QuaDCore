...
struct QUAD_DLL_DECL instance_sunwell_plateau : public ScriptedInstance
{
    ...
    /*** Misc ***/
    uint32 SpectralLogonTimer;
    std::vector<uint64> SpectralLogonList;
    ...
    Player* GetPlayerInMap()
    {
        ...
        debug_log("QSCR: Instance Sunwell Plateau: GetPlayerInMap, but PlayerList is empty!");
        return NULL;
    }
