...
struct QUAD_DLL_DECL flesh_tentacleAI : public Scripted_NoMovementAI
{
...
struct QUAD_DLL_DECL eye_of_cthunAI : public Scripted_NoMovementAI
{
    eye_of_cthunAI(Creature *c) : Scripted_NoMovementAI(c)
    {
        ...
        if (!pInst)
            error_log("QSCR: No Instance eye_of_cthunAI");
    }
...
struct QUAD_DLL_DECL cthunAI : public Scripted_NoMovementAI
{
...
struct QUAD_DLL_DECL eye_tentacleAI : public Scripted_NoMovementAI
{
...
struct QUAD_DLL_DECL claw_tentacleAI : public Scripted_NoMovementAI
{
...
struct QUAD_DLL_DECL giant_claw_tentacleAI : public Scripted_NoMovementAI
{
...
struct QUAD_DLL_DECL giant_eye_tentacleAI : public Scripted_NoMovementAI
{
...
void flesh_tentacleAI::JustDied(Unit* killer)
{
    if (!Parent)
    {
        error_log("QSCR: flesh_tentacle: No Parent variable");
        return;
    }
    ...
    else error_log("QSCR: flesh_tentacle: No Cthun");
}
