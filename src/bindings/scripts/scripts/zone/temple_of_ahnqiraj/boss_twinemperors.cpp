...
struct QUAD_DLL_DECL boss_twinemperorsAI : public ScriptedAI
{
    ...
    Creature *RespawnNearbyBugsAndGetOne()
    {
        ...
        Quad::CreatureListSearcher<AnyBugCheck> searcher(m_creature, unitList, u_check);
        TypeContainerVisitor<Quad::CreatureListSearcher<AnyBugCheck>, GridTypeMapContainer >  grid_creature_searcher(searcher);
