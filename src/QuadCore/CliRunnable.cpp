...
/// Delete a user account and all associated characters in this logon
/// \todo This function has to be enhanced to respect the login/logon split (delete char, delete account chars in logon, delete account chars in logon then delete account
...
/// Display info on users currently in the logon
bool ChatHandler::HandleAccountOnlineListCommand(const char* args)
{
    ///- Get the list of accounts ID logged to the logon
